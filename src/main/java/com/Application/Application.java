...
import com.Application.Controller.LibraryController;
 ...
 * Refer to the LibraryController class for API documentation and instructions on 
...
public class Application {
     ...
     */
    /**
     * This method is used to drop and recreate the book and author tables for setup purposes.
     * This is not a normal way to set up the tables. In a production environment, database schemas should be 
     * managed using a SQL editor, such as DBeaver or DataGrip.
     */
